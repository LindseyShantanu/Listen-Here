...
INSERT INTO listener(listener_name, favorites_fk, about) VALUES ("Lucie", 1, "Enjoys podcasts and long walks on the beach");
INSERT INTO listener(listener_name, favorites_fk, about) VALUES ("Sarah", 2, "Enjoys podcasts and her dogs");
INSERT INTO listener(listener_name, favorites_fk, about) VALUES ("Khalil", 3, "New here.");
INSERT INTO listener(listener_name, favorites_fk, about) VALUES ("Tahmid", 4, "Love a good true crime!");
INSERT INTO listener(listener_name, favorites_fk, about) VALUES ("Kyren", 5, "AKA Buzzlightyear");
